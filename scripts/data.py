...
class VideoDatasetWithLabels(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ct_up = int(ct_length - 1 - self.data_table.at[index]['CT上界'])
        ct_down = int(ct_length - 1 - self.data_table.at[index]['CT下界'])
        ...
        pet_up = int(self.data_table.at[index]['PET上界'])
        pet_down = int(self.data_table.at[index]['PET下界'])
